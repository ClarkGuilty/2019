...
Esta ha llevado a la detección de estrellas binarias, al mejoramiento de la escala de distancias, y fuertes avances en astrofísica estelar.
...
Los métodos tradicionales de búsqueda se han probado efectivos, pero al aumentar el tamaño y número de las observaciones se vuelven ineficientes, e incluso arbitrarios. Entonces, es necesaria la exploración de diferentes métodos para automatizar la búsqueda y mejorar los catálogos de estrellas variables.

En este proyecto se busca entrenar un clasificador de estrellas variables que reciba series de tiempo y devuelva candidatos a estrella variables.
Se procesarán datos públicos del proyecto Araucaria de la galaxia NGC 300 para obtener series de tiempo y utilizar el clasificador sobre ellas.
...
El objetivo final del proyecto es generar un catálogo de estrellas variables para la galaxia NGC 300.
