...
Adicionalmente, el Proyecto Araucaria empieza a operar en el año 2000 y publica sus primeros resultados sobre las galaxias de interés durante la misma década.
...
Además, ha realizado estudios adicionales en infrarrojo cercano para confirmar las distancias \cite{2008ApJ...672..266G, 2009ApJ...700.1141G,2017ApJ...847...88Z}
...
Sumado a esto, la detección de estrellas variables se hace tradicionalmente estudiando la tendencia de la curva desviación-magnitud de la población, con el fin de generar una lista más reducida de estrellas candidatas.
Luego estudiar las curvas de luz y los periodogramas de tales candidatas \cite{alejandroThesis}.
Sim embargo, en la última década se ha trabajado nuevas técnicas de clasificación haciendo uso de métodos de Machine Learning para sistematizar la búsqueda.
