...
El proyecto Araucaria nace en 2001 con el objetivo principal de mejorar la calibración de la escala de distancia en el universo local. Ello a través de estudiar los efectos de la edad y la metalicidad en la determinación de distancias usando poblaciones estelares \cite{2006MmSAI..77..239P}.
...
\begin{itemize}
	\item Realizar fotometría PSF usando los datos públicos de alguna de las galaxias del proyecto Araucaria tales, como NGC 55, NGC 247 y NGC 7793, con el fin de generar series de tiempo de magnitud para su población estelar.
