...
x = np.array([ridder(funcionTestFourier,freq[0],freq[1]),ridder(funcionTestFourier,freq[2],freq[4]),ridder(funcionTestFourier,freq[4],freq[6])]) #se hace manualmente.
